...
public class PostController {
    ...
    @PostMapping
    public ResponseEntity<Post> createPost(@RequestBody CreationPostRequest postRequest) throws CategoryNotFoundByIdException, PostNotFoundByIdException {
    ...
    @GetMapping("{id}")
    public ResponseEntity<List<Post>> getPostByCategory(@PathVariable UUID id) throws CategoryNotFoundByIdException {
    ...
    @PutMapping("{id}")
    public ResponseEntity<Post> updatePost(@PathVariable UUID id,@RequestBody CreationPostRequest postRequest) throws PostNotFoundByIdException {
